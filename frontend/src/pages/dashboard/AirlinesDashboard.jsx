...
import userImg from "../../assets/dashboard/img1.svg";
  ...
  return (
    <div className="flex">
      <div
        className={` ${
          open ? "w-72" : "w-20 "
        } bg-white min-h-[100vh] max-h-[100%] p-5  pt-8 relative duration-300`}
      >
        <img
          src={control}
        ...
        <Link to="/" className="flex gap-x-4 items-center justify-center">
          <img
            src={logo}
            className={`cursor-pointer duration-500 h-auto w-20 rounded-full border-[1px] border-black justify center${
              !open && "w-[100px] h-auto"
            } ${open && "rotate-[360deg]"}`}
          />
        </Link>
        ...
        <div className="flex items-end h-[55%] absolute bottom-6 w-[80%]">
          <div
      ...
      <div className="h-[100%] flex-1 p-7 bg-[#F6F8FA]">
        <div className="w-[100%] flex justify-between p-2 px-4 pr-8">
          <div>
            ...
            <p className="text-[#BBBCC5] text-[16px]">
              Let's check the Aircraft parts Today!
            </p>
          </div>
