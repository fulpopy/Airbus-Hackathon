function recycledPartCarbonFoot(data) {
  var npcf = {
    "Engine": [0, 0],
    "Landing Gear": [0, 0],
    "Avionics": [0, 0],
  ...
  for (let i = 0; i < data.length; i++) {
    var { partName, condition, recycledPartCarbonFoot } = data[i];
    if (condition === "Used") {
      //   console.log(newPartCarbonFoot);
      npcf[partName][0] += recycledPartCarbonFoot;
      npcf[partName][1] += 1;
    }
  }
  console.log("recycledPartCarbonFoot");
  console.log(npcf);
}
function recycledPartCarbonFoot() {}
function waterUsageNewPart() {}
function waterUsageRecycledPart() {}
const data = [
  {
    id: 2,
